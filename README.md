...
- [Arena System Guide](docs/system-guide.md): roles, lifecycle, question splits, judge profiles, student workflow, and launch checklist.
- [LLM Prompt Contest Guide: Game 24](docs/prompt-contest-guide.md): recommended setup for a Prompt-only contest where the instructor provides the model.
- [LLM Agent Contest Guide: Game 24](docs/agent-contest-guide.md): recommended setup for an agent contest where students connect OpenAI-compatible APIs, Dify, or Coze.
